        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              ..._getWidgetMap(
                  key: 'Gender:', value: personEntity.gender ?? ''),
              ..._getWidgetMap(
                  key: 'Number of episodes:',
                  value: '${personEntity.episode?.length ?? 0}'),
              ..._getWidgetMap(
                  key: 'Species:', value: personEntity.species ?? ''),
              ..._getWidgetMap(
                  key: 'Last known location:',
                  value: personEntity.location?.name ?? ''),
              ..._getWidgetMap(
                  key: 'Origin:', value: personEntity.origin?.name ?? ''),
              ..._getWidgetMap(
                  key: 'Was created:',
                  value: _getDateTimeString(personEntity.created)),
            ],
          ),
        ));
  }
